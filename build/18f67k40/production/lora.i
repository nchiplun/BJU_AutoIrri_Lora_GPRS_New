...
void transmitNumberToLora(char *number, unsigned char index) {
    unsigned char j = 0;
...
void sendCmdToLora(unsigned char Action, unsigned char FieldNo) {
    ...
    case 0x01:
        ...
        break;
    case 0x02:
        transmitStringToLora("#GETSENSOR");
        _delay((unsigned long)((10)*(64000000/4000.0)));
...
_Bool isLoraResponseAck(unsigned char Action, unsigned char SlaveNo) {
    ...
    case 0x02:
        ...
        slave_num = fetchDigits(index+5)+1;
    ...
    if(strncmp((char*)(decodedString+1),(char*)(master),(6)) == 0 && strncmp((char*)(decodedString+7),(char*)(error),(5)) == 0) {
        return 0;
    }
    else if(strncmp((char*)(decodedString+1),(char*)(slave),(5)) == 0 && strncmp((char*)(decodedString+6),(char*)(error),(5)) == 0) {
        return 0;
    }
    return 0;
