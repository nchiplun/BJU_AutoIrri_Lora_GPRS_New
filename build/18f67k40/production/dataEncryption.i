...
# 2 "<built-in>" 2
# 1 "dataEncryption.c" 2
# 11 "dataEncryption.c"
# 1 "./variableDefinitions.h" 1
# 49 "./variableDefinitions.h"
# 1 "./congfigBits.h" 1
# 16 "./congfigBits.h"
...
unsigned char deviceId[13] = "a0d1d8668dd8";
...
const char cmd[7] = "*AUOK#";
const char cmd0[10] = "*AUERROR#";
const char cmd1[10] = "*ALIVEOK#";
const char cmd2[12] = "*BATTERYOK#";
const char cmd3[15] = "*BATTERYERROR#";
const char cmd4[8] = "*SETOK#";
const char cmd5[9] = "*HOLDOK#";
const char cmd6[11] = "*ENABLEOK#";
const char cmd7[18] = "*ENABLEINCORRECT#";
const char cmd8[14] = "*ENABLEERROR#";
const char cmd9[12] = "*DISABLEOK#";
const char cmd10[11] = "*ACTIVEOK#";
const char cmd11[12] = "*DACTIVEOK#";
const char cmd11_1[14] = "*ACTIVEERROR#";
const char cmd12[9] = "*FEEDOK#";
const char cmd13[12] = "*FEEDERROR#";

const char cmd15[7] = "*CTOK#";
const char cmd16[10] = "*CTERROR#";
const char cmd17[42] = "*CT<SAPCE><NoLOADVALUE><SPACE><FULLLOAD>#";
const char cmd18[7] = "*FREQ ";
const char cmd19[12] = "*FREQEROOR#";
const char cmd20[42] = "*CT<SAPCE><NoLOADVALUE><SPACE><FULLLOAD>#";
const char cmd21[13] = "*CTSETERROR#";
const char cmd22[8] = "*MAPOK#";
const char cmd23[11] = "*MAPERROR#";
const char time1[20] = "*01 01 25 10 10 10#";


const char CmdIrr1[33] = "Irrigation configured for field ";
const char CmdIrr2[45] = "Irrigation configuration disabled for field ";
const char CmdIrr3[37] = "Irrigation not configured for field ";
const char NotIrr4[30] = "Irrigation started for field ";
const char NotIrr5[30] = "Irrigation stopped for field ";
const char NotIrr6[57] = "Wet field detected.\r\nIrrigation not started for field ";
const char CmdIrr7[15] = "Irrigation No:";
const char NotIrr8[48] = "Irrigation skipped with no response from field ";
const char NotIrr9[48] = "Irrigation stopped without response from field ";
const char CmdIrr10[36] = "Irrigation field mapped with valves";

const char CmdFert1[61] = "Irrigation is not Active. Fertigation not enabled for field ";
const char CmdFert2[53] = "Incorrect values. Fertigation not enabled for field ";
const char CmdFert3[31] = "Fertigation enabled for field ";
const char CmdFert4[32] = "Fertigation disabled for field ";
const char NotFert5[31] = "Fertigation started for field ";
const char NotFert6[31] = "Fertigation stopped for field ";
const char NotFert7[68] = "Fertigation stopped with fertilizer level sensor failure for field ";
const char NotFert8[57] = "Fertigation stopped with low fertilizer level for field ";
...
const char NotSR01[60] = "System restarted with phase failure, suspending all actions";
const char NotSR02[75] = "System restarted for Power Interrupt with incomplete Irrigation for field ";
const char NotSR03[72] = "System restarted for Low Power In with incomplete Irrigation for field ";
const char NotSR04[74] = "System restarted in Diagnostic Mode with incomplete Irrigation for field ";
const char NotSR05[79] = "System restarted for All Phase Detection with incomplete Irrigation for field ";
const char NotSR06[71] = "System restarted for WDT Timeout with incomplete Irrigation for field ";
const char NotSR07[71] = "System restarted for Stack Error with incomplete Irrigation for field ";
const char NotSR08[37] = "System restarted for Power Interrupt";
const char NotSR09[31] = "System restarted for Low Power";
const char NotSR10[36] = "System restarted in Diagnostic mode";
const char NotSR11[41] = "System restarted for All Phase Detection";
const char NotSR12[33] = "System restarted for WDT timeout";
const char NotSR13[33] = "System restarted for stack error";
const char NotSR14[59] = "System reset occurred, login code reset to Factory setting";
const char NotSR15[50] = "System reset occurred, Irrigation setting deleted";

const char NotRTC1[50] = "RTC Battery found low, please replace RTC battery";
const char CmdRTC2[41] = "System time synced to current local time";
const char NotRTC3[56] = "New RTC battery found, system time is set to local time";
const char NotRTC4[56] = "New RTC battery found, please sync system time manually";

const char NotDR1[130] = "Dry Run detected, Motor, Irrigation and Fertigation switched off.\r\nIrrigation scheduled to next day with fertigation for field ";
const char NotDR2[117] = "Dry Run detected, Motor and Irrigation switched off.\r\nIrrigation scheduled to next day with fertigation for field ";
const char NotDR3[100] = "Dry Run detected, Motor and Irrigation switched off.\r\nIrrigation scheduled to next day for field ";
const char NotDR4[105] = "Dry Run detected, Motor and Irrigation switched off.\r\nIrrigation scheduled to next due date for field ";

const char CmdT1[27] = "Incorrect local time found";
const char CmdT2[15] = "Current Time: ";

const char NotMotor1[58] = "Irrigation completed for due fields\r\nMotor switched off";
const char CmdMotor2[35] = "Motorload cut-off set successfully";
const char CmdMotor3[47] = "NoLoad and FullLoad Motor thresholds set to : ";
const char CmdMotor4[49] = "Irrigation is active, Motor load cut-off not set";

const char CmdConnect[17] = "System Connected";





const char NotPh1[47] = "Phase failure detected, suspending all actions";
const char NotPh2[69] = "Low Phase current detected, actions suspended, please restart system";
const char NotPh3[25] = "Phase loss detected";


const char NotPh6[19] = "All Phase detected";

const char NotMS1[57] = "Moisture sensor is failed, Irrigation started for field ";
const char CmdMS2[43] = "Moisture sensor frequency value for field ";
const char CmdMS3[37] = "Moisture sensor is failed for field ";



#pragma idata gsmResponse
unsigned char gsmResponse[200] = "HELLO";
unsigned char fieldMap[96] = {'\0'};
