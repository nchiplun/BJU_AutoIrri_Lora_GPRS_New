...
void saveDeviceIDIntoEeprom(void) {
    ...
    for (iterator = 0; iterator < 12; iterator++) {
        _delay((unsigned long)((50)*(64000000/4000.0)));
        eepromWrite(eepromAddress[21] + iterator, deviceId[iterator]);
    }
    _delay((unsigned long)((50)*(64000000/4000.0)));
...
void saveFieldMappingIntoEeprom(void) {
    ...
    for (iterator = 0; iterator < 96; iterator++) {
        _delay((unsigned long)((50)*(64000000/4000.0)));
        eepromWrite(eepromAddress[19] + iterator, fieldMap[iterator]);
    }
    _delay((unsigned long)((50)*(64000000/4000.0)));
...
void saveActiveSleepCountIntoEeprom(void) {
    ...
    _delay((unsigned long)((50)*(64000000/4000.0)));
    eepromWrite(eepromAddress[17] + 1, sleepCount & 0xFF);
    _delay((unsigned long)((50)*(64000000/4000.0)));
    eepromWrite(eepromAddress[17] + 2, (sleepCount >> 8) & 0xFF);
    _delay((unsigned long)((50)*(64000000/4000.0)));
...
void saveResetCountIntoEeprom(void) {
    ...
    _delay((unsigned long)((50)*(64000000/4000.0)));
    eepromWrite(eepromAddress[17] + 7, resetCount);
    _delay((unsigned long)((50)*(64000000/4000.0)));
...
void saveDeviceProgramStatusIntoEeprom(void) {
    ...
    _delay((unsigned long)((50)*(64000000/4000.0)));
    eepromWrite(eepromAddress[17] + 8, DeviceBurnStatus);
    _delay((unsigned long)((50)*(64000000/4000.0)));
...
void saveMotorLoadValuesIntoEeprom(void) {
    ...
    _delay((unsigned long)((50)*(64000000/4000.0)));
    eepromWrite(eepromAddress[17] + 9, noLoadCutOff & 0xFF);
    _delay((unsigned long)((50)*(64000000/4000.0)));
    eepromWrite(eepromAddress[17] + 10, (noLoadCutOff >> 8) & 0xFF);
    _delay((unsigned long)((50)*(64000000/4000.0)));
    eepromWrite(eepromAddress[17] + 11, fullLoadCutOff & 0xFF);
    _delay((unsigned long)((50)*(64000000/4000.0)));
    eepromWrite(eepromAddress[17] + 12, (fullLoadCutOff >> 8) & 0xFF);
    _delay((unsigned long)((50)*(64000000/4000.0)));
...
void readMotorLoadValuesFromEeprom(void){
    ...
    _delay((unsigned long)((50)*(64000000/4000.0)));
    lower8bits = eepromRead(eepromAddress[17] + 9);
    _delay((unsigned long)((50)*(64000000/4000.0)));
    lower8bits &= 0x00FF;
    higher8bits = eepromRead(eepromAddress[17] + 10);
    _delay((unsigned long)((50)*(64000000/4000.0)));
    higher8bits <<= 8;
    higher8bits &= 0xFF00;
    noLoadCutOff = ((lower8bits) | (higher8bits));
    lower8bits = eepromRead(eepromAddress[17] + 11);
    _delay((unsigned long)((50)*(64000000/4000.0)));
    lower8bits &= 0x00FF;
    higher8bits = eepromRead(eepromAddress[17] + 12);
    higher8bits <<= 8;
    higher8bits &= 0xFF00;
...
void readResetCountFromEeprom(void) {
    ...
    resetCount = eepromRead(eepromAddress[17] + 7);
    _delay((unsigned long)((50)*(64000000/4000.0)));
...
void readDeviceProgramStatusFromEeprom(void) {
    ...
    DeviceBurnStatus = eepromRead(eepromAddress[17] + 8);
    _delay((unsigned long)((50)*(64000000/4000.0)));
...
void saveRemainingFertigationOnPeriod(void) {
    ...
    _delay((unsigned long)((50)*(64000000/4000.0)));
    eepromWrite(eepromAddress[17] + 3, remainingFertigationOnPeriod & 0xFF);
    _delay((unsigned long)((50)*(64000000/4000.0)));
    eepromWrite(eepromAddress[17] + 4, (remainingFertigationOnPeriod >> 8) & 0xFF);
    _delay((unsigned long)((50)*(64000000/4000.0)));
...
unsigned int readActiveSleepCountFromEeprom(void) {
    ...
    _delay((unsigned long)((50)*(64000000/4000.0)));
    lower8bits = eepromRead(eepromAddress[17] + 1);
    _delay((unsigned long)((50)*(64000000/4000.0)));
    lower8bits &= 0x00FF;
    higher8bits = eepromRead(eepromAddress[17] + 2);
    _delay((unsigned long)((50)*(64000000/4000.0)));
    higher8bits <<= 8;
    higher8bits &= 0xFF00;
...
unsigned int readRemainingFertigationOnPeriodFromEeprom(void) {
    ...
    _delay((unsigned long)((50)*(64000000/4000.0)));
    lower8bits = eepromRead(eepromAddress[17] + 3);
    _delay((unsigned long)((50)*(64000000/4000.0)));
    lower8bits &= 0x00FF;
    higher8bits = eepromRead(eepromAddress[17] + 4);
    _delay((unsigned long)((50)*(64000000/4000.0)));
    higher8bits <<= 8;
    higher8bits &= 0xFF00;
...
void saveAuthenticationStatus(void) {
    ...
    _delay((unsigned long)((50)*(64000000/4000.0)));
    eepromWrite(eepromAddress[17], systemAuthenticated);
    _delay((unsigned long)((50)*(64000000/4000.0)));
...
void saveDeviceIdStatus(void) {
    ...
    _delay((unsigned long)((50)*(64000000/4000.0)));
    eepromWrite(eepromAddress[17] + 13, deviceIdSet);
    _delay((unsigned long)((50)*(64000000/4000.0)));
...
void saveRTCBatteryStatus(void) {
    ...
    _delay((unsigned long)((50)*(64000000/4000.0)));
    eepromWrite(eepromAddress[17] + 6, lowRTCBatteryDetected);
    _delay((unsigned long)((50)*(64000000/4000.0)));
...
void saveIrrigationValveNoIntoEeprom(unsigned char field_no) {
    ...
    _delay((unsigned long)((50)*(64000000/4000.0)));
    eepromWrite(eepromAddress[17] + 5, field_no);
    _delay((unsigned long)((50)*(64000000/4000.0)));
...
unsigned char readFieldIrrigationValveNoFromEeprom(void) {
    ...
    _delay((unsigned long)((50)*(64000000/4000.0)));
    field_no = eepromRead(eepromAddress[17] + 5);
    _delay((unsigned long)((50)*(64000000/4000.0)));
...
void loadDataFromEeprom(void) {
    ...
    for (iterator = 0; iterator < fieldCount; iterator++) {
        ...
        sprintf((char *)temporaryBytesArray,"%d%c",(iterator+1)*6,0x25);
    ...
    for (iterator = 0; iterator < 12; iterator++) {
        _delay((unsigned long)((50)*(64000000/4000.0)));
        deviceId[iterator] = eepromRead(eepromAddress[21] + iterator);
    }
    ...
    factryPswrd[6] = '\0';
     for (iterator = 0; iterator < 96; iterator++) {
        _delay((unsigned long)((50)*(64000000/4000.0)));
        fieldMap[iterator] = eepromRead(eepromAddress[19] + iterator);
    }

    lcdWriteStringAtCenter("99%", 3);

    _delay((unsigned long)((50)*(64000000/4000.0)));
    systemAuthenticated = eepromRead(eepromAddress[17]);
    _delay((unsigned long)((50)*(64000000/4000.0)));
    deviceIdSet = eepromRead(eepromAddress[17] + 13);
    _delay((unsigned long)((50)*(64000000/4000.0)));
    lowRTCBatteryDetected = eepromRead(eepromAddress[17] + 6);
    _delay((unsigned long)((50)*(64000000/4000.0)));
