...
_Bool isLoraResponseAck(unsigned char Action, unsigned char SlaveNo) {
    ...
    case 0x00:    // check for Valve ON ack response
        slave_num = fetchDigits(10)+1; // fetchFieldNo response 0 for 01
    ...
    case 0x01:    // check for Valve OFF ack response
        slave_num = fetchDigits(11)+1; // fetchFieldNo response 0 for 01
    ...
    case 0x02:   // check for SENSOR measurement reading response
        ...
        slave_num = fetchDigits(index+5)+1; // fetchFieldNo response 0 for 01
